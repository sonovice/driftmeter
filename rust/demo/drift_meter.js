...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_03576eb897082378179e0868a122bb4fe0740c51": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var array = ($0); var pointer = ($1); HEAPF32.set (array , pointer);
            },
    ...
    function __instantiate( instance ) {
        ...
        Module.exports.process_audio = function process_audio(buf) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.process_audio(Module.STDWEB_PRIVATE.prepare_any_arg(buf)));
}
;
    ...
    if( __load_asynchronously ) {
        return WebAssembly.instantiate( __wasm_module, __imports )
            .then( instance => {
                ...
                console.log( "Finished loading Rust wasm module 'drift_meter'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'drift_meter':", error );
                throw error;
            });
    } else {
    ...
    if( typeof window === "undefined" && typeof process === "object" ) {
        ...
        const wasm_path = path.join( __dirname, "drift_meter.wasm" );
        const buffer = fs.readFileSync( wasm_path );
        const mod = new WebAssembly.Module( buffer );

        return __initialize( mod, false );
    } else {
        return fetch( "drift_meter.wasm", {credentials: "same-origin"} )
